...
func main() {
	...
	newClient := Client{
		FIO:      "Ryan Gosling",      // укажите ФИО
		Login:    "gosling1980",       // укажите логин
		Birthday: "19801112",          // укажите день рождения
		Email:    "gosling@yandex.ru", // укажите почту
	}
	...
	newLogin := "gosling_new" // укажите новый логин
...
// insertClient добавляет запись в таблицу clients. Возвращает
// идентификатор добавленной записи и ошибку
...
// updateClientLogin обновляет поле login у записи с заданным id в таблице clients. Возвращает ошибку
...
// deleteClient удаляет запись из таблицы clients по заданному id. Возвращает ошибку.
